...
Set `dataTestId="settings-modal"` on the modal. The root id is on the dialog panel; related regions use suffixed ids:
...
>
  <Typography variant="p">Update your preferences.</Typography>
</Modal>
```
